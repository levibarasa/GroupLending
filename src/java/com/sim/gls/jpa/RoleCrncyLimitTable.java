...
public class RoleCrncyLimitTable  implements java.io.Serializable {
    ...
    public RoleCrncyLimitTable(long limitId, String bankId, String crncyCode, String delFlg, Date lchgDate, Date rcreTime, String roleId, double userCashDrLim, double userIntersolCashDrLimit, double userIntersolXferDrLimit, double userXferDrLim) {
