...
/**
 * DailyTransactionsTable generated by hbm2java
 */
public class DailyTransactionsTable  implements java.io.Serializable {
    ...
    public DailyTransactionsTable() {
    }

    public DailyTransactionsTable(int tranId, String foracid, String bankTranId, String delFlg, Date lchgTime, String lchgUserId, String pstdFlg, Date rcreTime, String rcreUserId, String subGroupCode, BigDecimal tranAmt, Date tranDate, String tranParticulars, String tranType) {
       this.tranId = tranId;
