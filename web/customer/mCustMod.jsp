    ...
    <div class="div">
        <table width="95%" align="center"  style="border:#5757D9 solid 2px;padding:10px;" border="1">
            ...
            <tr style="height:30px; padding:4px;">
                ...
                <td><div align="center"><%=(java.util.Date) one.get(3)%></div></td>
                ...
                <td>
                    <input value="Verify" type="button" class="redButton" onclick="javascript:deleteDriver(<%=(int) one.get(0)%>)" size="6"/>
                </td>
            </tr>
            <% }%>
        </table>
