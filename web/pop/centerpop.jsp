...
<html>
    <%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
             java.util.*" errorPage="" %>
    <%
        ArrayList all = Category.getCategories("LOCATION");
        int size = all.size();
    %>	
    <head>
        <style type="text/css">
        ...
        <script type="text/javascript">
            function getCenterValue(ths) {
                if (window.opener !== null && !window.opener.closed) {
                    var func = window.opener.document.getElementById("groupcenter");
    ...
    <form id="popup">
        <table width="95%" align="center"  style="border:#013567 solid 2px;padding:10px;" border="0">
            ...
            <tr style="height:30px; padding:4px;">
                <td><div align="center"><a href="" onclick="getCenterValue(this)" id="cname"><%=(String) one.get(2)%></a></div></td>
